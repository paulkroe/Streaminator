...
class GSM8KAnswerChecker:
    """
    A utility class for evaluating generated answers against ground truth answers
    ...
    def _remove_think_tags(text):
        """
        Removes <think> tags and their content from the text.
        """
    ...
    def _extract_answer(text):
        """
        Extracts a numeric answer from the text using various heuristics.
        """
    ...
    def check_answer(answer, ground_truth):
        """
        Compares a generated answer to the ground truth and evaluates correctness.
    ...
    def eval(output_dict):
        """
        Evaluates a dictionary of generated outputs against ground truth answers.

        Args:
            output_dict (dict): A dictionary mapping prompt text to:
                {
        ...
        Returns:
            list: A list of dictionaries containing evaluation data for each prompt.
        """
        evaluated_outputs = []
